...
activities = {
    ...
    "Drama Society": {
        "description": "Theater productions, acting workshops, and stagecraft",
        "schedule": "Thursdays, 5:00 PM - 7:30 PM",
        "max_participants": 25,
    ...
    "Debate Team": {
        "description": "Practice debating skills and participate in tournaments",
